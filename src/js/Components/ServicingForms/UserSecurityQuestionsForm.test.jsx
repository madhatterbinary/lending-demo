...
import UserSecurityQuestionsForm from './UserSecurityQuestionsForm';

describe('UserSecurityQuestionsForm main view Component', () => {
  let component;
  let props;
  let mockSubmit;
  beforeEach(() => {
    ...
    component = shallow(<UserSecurityQuestionsForm onSubmit={ mockSubmit } { ...props } />);
  });
