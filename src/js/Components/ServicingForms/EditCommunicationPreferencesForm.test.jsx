...
import EditCommunicationPreferencesForm from './EditCommunicationPreferencesForm';
...
describe('SignDocsForm main view Component', () => {
  ...
  beforeEach(() => {
    ...
    component = shallow(<EditCommunicationPreferencesForm onSubmit={ mockSubmit } { ...props } />);
  });
